...
if __name__ == "__main__":
    ...
    parser.add_argument('-config_path', '--config-path', default=UserDataFolders.resource_user_configs_folder("eyetrack_settings.json").as_posix(), help='Path to the config file') # L:\repos\ExternalTesting\EyeTrackVR\user_data\user_configs\eyetrack_settings.json
